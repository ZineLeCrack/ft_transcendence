...
export interface Router {
    method: string;
    path: string;
    handler: (req: Http.IncomingMessage, res: Http.ServerResponse) => string | Buffer;
}
...
export interface TransformPlugin {
    ...
    name?: string;
    enforce?: 'post' | 'pre';
    transform?: (fileData: string, fileUrl: FileUrl, lentHttpInstance?: LentHttpInstance) => string | Promise<string>;
}
...
export interface LentHttpInstance {
    ...
    config: {
        ...
        middle?: Array<(m: MiddlewareHttp, next?: MiddlewareNext) => Promise<any> | void>;
    };
}
