...
exports.draw_ai = void 0;
var pong_ai_js_1 = require("./pong-ai.js");
/* ------------------------------- STAT PART ---------------------------------------- */
...
function draw_ai() {
    ...
    game.shadowBlur = 10;
    game.fillText(pong_ai_js_1.message, 400 - (pong_ai_js_1.message.length * 14), 150);
    for (var i = 0; i < 600; i += 18.9)
        game.fillRect(404, i, 2, 15);
    game.fillStyle = "#00FFFF";
    game.shadowColor = "#00FFFF";
    game.shadowBlur = 10;
    game.fillRect(5, pong_ai_js_1.leftPaddleY, pong_ai_js_1.paddleWidth, pong_ai_js_1.paddleHeight);
    game.fillStyle = "#FF007A";
    game.shadowColor = "#FF007A";
    game.shadowBlur = 10;
    game.fillRect(gameCanvas.width - pong_ai_js_1.paddleWidth - 5, pong_ai_js_1.rightPaddleY, pong_ai_js_1.paddleWidth, pong_ai_js_1.paddleHeight);
    game.fillStyle = "#FFFFFF";
    game.shadowColor = "#FFFFFF";
    game.shadowBlur = 10;
    game.fillRect(pong_ai_js_1.ballX, pong_ai_js_1.ballY, 10, 10);
    score.fillStyle = "#00FFFF";
    score.shadowColor = "#00FFFF";
    score.shadowBlur = 10;
    score.fillText(pong_ai_js_1.leftScore.toString(), 20, 50);
    score.fillStyle = "#FF007A";
    score.shadowColor = "#FF007A";
    score.shadowBlur = 10;
    score.fillText(pong_ai_js_1.rightScore.toString(), topCanvas.width - 50, 50);
}
exports.draw_ai = draw_ai;
