...
const game_router_multi_js_1 = __importDefault(require("./game_router_multi.js"));
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield app.register(game_router_multi_js_1.default, { prefix: '/game' });
        yield app.listen({ port: 4001, host: '0.0.0.0' });
